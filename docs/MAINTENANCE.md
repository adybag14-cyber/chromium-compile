...
5. Resolve depot_tools, GN, Ninja and Clang from immutable pins in Chromium `DEPS`; disable depot_tools self-update and the Google-internal Windows toolchain path.
