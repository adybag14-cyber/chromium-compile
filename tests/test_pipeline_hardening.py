...
class PipelineHardeningTests(unittest.TestCase):
    ...
    def test_release_provenance_is_exact_and_immutable(self):
        ...
        self.assertIn("repos/${GITHUB_REPOSITORY}/immutable-releases", publish)
        self.assertIn("isImmutable", publish)
        self.assertIn("Repository-level immutable releases must be enabled before publication", publish)
