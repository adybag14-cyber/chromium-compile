...
- Source tarballs are integrity-tested before extraction, the extracted `chrome/VERSION` must exactly match the requested version, and a corrupt version cache is discarded rather than trusted.
